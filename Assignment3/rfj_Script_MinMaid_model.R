...
MinMaid=rfjdata[which(rfjdata$upc==2500002606 & rfjdata$price>0 & rfjdata$move>0),]

print(dim(MinMaid))
myvars <- c("store", "week", "price","move")
MinMaid = MinMaid[myvars]
print(dim(MinMaid))
...
print(sum(trop$scluster=="D"))
print(sum(!is.na(trop$income)))
